    ...
    return(
        <div className='main'>
            ...
            <Grid container xs={12} sm={12} md={12} lg={12} spacing={0} rowSpacing={0}>
                ...
                <Grid item xs={12} sm={12} md={12} lg={6} order={{xs:4, sm:4, md:4, lg: 3}}>
                ...
                <Grid item xs={12} sm={12} md={12} lg={6} order={{xs:3, sm:3, md:3, lg: 4}}>
                ...
                <Grid item xs={12} sm={12} md={12} lg={6} order={{xs:4, sm:4, md:4, lg: 4}}>
