        ...
        <div>
            <Container className="wholeContainer" sx={{
                ...
                <Container className="AGBContainer">
                    <Box>
                        <h1 className="text-white">Allgemeine Geschäftsbedingungen der Firma Kinovation</h1>
                        ...
                        <Box className="mainNameBox" sx={{fontStyle: "italic"}}>
                            <p className="text-white">Mathis Neunzig</p>
                            <p className="text-white">Parkring 21</p>
                            <p className="text-white">D-68159 Mannheim</p>
                            <p className="text-white">E-Mail: mathis.neunzig@gmail.com</p>
                        </Box>
                        <p/>
